...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    subtitle: "For Banks, NIN, BVN, Passports, NYSC, Marriage & more.",
    icon: TextT,
  },
  {
    id: "AGE_DECLARATION",
    ...
    subtitle: "Official age declaration for Banks, NIN, Pension, Civil Service & more.",
    icon: Cake,
  },
  {
    id: "CAC_CORPORATE",
    ...
    subtitle: "Loss of CAC Certificate, MEMART, Signatures, Corrections & more.",
    icon: Buildings,
  },
  {
    id: "LOSS_OF_ITEM",
    ...
    subtitle: "For SIM Retrieval (MTN, Airtel, Glo), Lost IDs, Certificates & more.",
    icon: FileText,
  },
  {
    ...
    subtitle: "For Vehicles, Electronics, Property, Marital Status & more.",
    icon: Car,
  },
  {
    id: "GENERAL_PURPOSE",
    ...
    subtitle: "Custom sworn legal declarations for Embassies, Offices & more.",
    icon: Scales,
  },
];
