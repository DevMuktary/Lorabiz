      ...
      >
        ...
        <div className="max-h-[260px] overflow-y-auto space-y-3 pr-2 text-xs leading-relaxed border border-border/80 rounded-2xl p-4 bg-secondary/20">
          <div className="space-y-2 text-muted-foreground">
            <p>
              1. <strong>Mandatory Ownership &amp; Authorization:</strong> I confirm that I am either the <strong>legitimate registered owner</strong> of BVN <strong className="font-mono text-foreground">{bvn}</strong> or have been <strong>duly authorized</strong> by the BVN owner to submit this modification in accordance with the <strong>Nigeria Data Protection Act (NDPA) 2023</strong> and LoraBiz Service Terms.
            </p>
            <p>
