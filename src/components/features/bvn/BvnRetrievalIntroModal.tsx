    ...
    >
      ...
      >
        ...
        <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
          ...
          <p>
            Please ensure you have lawful authorization to query this record in accordance with the <strong>Nigeria Data Protection Act (NDPA) 2023</strong> and LoraBiz Service Terms.
          </p>
