...
export function ModificationForm({
  ...
  const [selectedType, setSelectedType] = useState<ModificationType>("CHANGE_OF_NAME");
  ...
  const activePricing = pricing[selectedType] || {
    price: selectedType === "CHANGE_OF_NAME" ? 2500 : 2000,
    isActive: true,
    label: selectedType.replace(/_/g, " "),
  };

  const hasSufficientBalance = walletBalance >= activePricing.price;
  const shortfall = Math.max(0, activePricing.price - walletBalance);
  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      {/* 1. Modification Type Selector Cards */}
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-start justify-between gap-3 mb-3">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-black bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
      ...
      {/* 2. Service Maintenance Banner if Inactive */}
      {!activePricing.isActive && (
      ...
      {/* 3. Dynamic Form */}
      <form onSubmit={handleProceedToReview} className="p-6 sm:p-8 rounded-3xl bg-card border border-border shadow-sm space-y-6">
        
        <div className="flex items-center justify-between border-b border-border pb-4">
          <div>
            <h2 className="text-lg font-black text-foreground tracking-tight">
              {activePricing.label} Details
            </h2>
            <p className="text-xs text-muted-foreground">
              Provide exact details as required by the National Identity database.
            </p>
          </div>
          <div className="text-right">
            <span className="text-xs font-bold text-muted-foreground block">Service Fee</span>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 rounded-xl bg-secondary/50 border border-border text-foreground text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background"
                  required
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-secondary/50 border border-border text-foreground text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background"
                  required
                />
              </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-secondary/50 border border-border text-foreground text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background resize-none"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-secondary/50 border border-border text-foreground text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background cursor-pointer"
                  required
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-secondary/50 border border-border text-foreground text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background disabled:opacity-50 cursor-pointer"
                  required
                >
        ...
        <div className="pt-4 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            <ShieldCheck weight="bold" className="h-4 w-4 text-emerald-500" />
      ...
      {showReviewModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-background border border-border shadow-2xl rounded-3xl max-w-lg w-full overflow-hidden text-foreground">
            ...
            <div className="p-5 border-b border-border bg-card/60 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Please review details before payment.</p>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setShowReviewModal(false)}
                className="text-xs font-bold text-muted-foreground hover:text-foreground px-2 py-1 rounded-lg bg-secondary/50"
              >
                Edit
              </button>
            </div>
            ...
            <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
              ...
              {/* Data Summary Card */}
              <div className="p-4 rounded-2xl bg-secondary/30 border border-border space-y-2.5 text-xs">
            ...
            {/* Modal Actions */}
            <div className="p-5 border-t border-border bg-card/60 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={() => setShowReviewModal(false)}
