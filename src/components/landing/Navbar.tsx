...
export default function Navbar() {
  ...
  const navItems = {
    services: [
      ...
      { name: "CAC Annual Returns", href: "/services/cac/annual-returns", icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg> },
