      ...
      >
        <div className="flex flex-col min-h-[calc(100dvh-96px)] px-6">
          ...
          <div className="flex-none space-y-2">
            ...
            <div className="pb-2">
              <button 
                ...
                className="flex items-center justify-start gap-2 w-full py-4 text-2xl font-medium text-zinc-900 dark:text-white transition-colors"
              >
                Services
              ...
              <div className={`grid transition-all duration-400 ease-in-out ${openDropdown === "services" ? "grid-rows-[1fr] opacity-100 mb-6" : "grid-rows-[0fr] opacity-0"}`}>
            ...
            <div className="py-4 flex items-center justify-start gap-2">
              <span className="text-2xl font-medium text-zinc-300 dark:text-white/20 cursor-not-allowed">
                Creators
              </span>
            </div>
          ...
          <div className="flex gap-4 pb-12 pt-8">
            ...
            <Link
              href="/auth/login"
              className="flex-1 flex items-center justify-center py-4 text-base font-semibold text-zinc-700 hover:text-zinc-900 dark:text-white/80 dark:hover:text-white border border-black/10 dark:border-white/10 rounded-xl bg-zinc-50 dark:bg-white/5 transition-colors"
              style={{ fontFamily: '"DM Sans", sans-serif' }}
            >
              Sign In
            </Link>
