          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-slate-200 font-medium text-sm">Staff Email Address</Label>
                <div className="relative">
                  ...
                  <Input 
                    ...
                    required 
                    placeholder="officer@quadrox.io" 
            ...
            <div className="pt-2">
              ...
              >
                {loading ? (
                  ...
                  <>Open Operations Desk <SignIn className="h-5 w-5" weight="bold" /></>
                )}
              </Button>
            </div>
