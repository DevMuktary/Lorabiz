...
import NinResultModal from "@/components/features/nin/slips/NinResultModal";
import NinHistorySection, { SlipHistoryItem } from "@/components/features/nin/slips/NinHistorySection";

export default function NinSlipsPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto p-4 sm:p-6 font-sans select-none relative pb-24 animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-4 border-b border-border pb-5">
        ...
        <div>
          <h1 className="text-2xl font-black text-foreground">NIN Slip Verification & Printing</h1>
          <p className="text-sm font-medium text-muted-foreground mt-0.5">Generate standardized official identity slips via NIN or Phone Number.</p>
        </div>
      </div>
