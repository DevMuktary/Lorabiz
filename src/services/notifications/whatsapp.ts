...
interface SendTemplateParams {
  ...
  templateName: "cac_application_submitted" | "cac_application_queried" | "cac_application_approved" | "scuml_application_approved";
  ...
  mediaUrl?: string; // NEW: Accepts the PDF URL for Document Headers
}
...
export async function sendWhatsAppTemplate({
  ...
  try {
    ...
    // 2. Build standard body component parameters
    ...
    // 3. If template has a dynamic URL button, append button parameter
