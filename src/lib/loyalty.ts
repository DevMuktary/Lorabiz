...
export const LOYALTY_TIERS: Record<LoyaltyTierLevel, TierConfig> = {
  TIER_1: {
    ...
    tierNumber: 1,
    name: "Bronze",
    fullName: "Level 1 (Bronze Starter)",
    ...
    description: "Starter level. Normal price for all services.",
  },
  TIER_2: {
    level: "TIER_2",
    tierNumber: 2,
    name: "Silver",
    fullName: "Level 2 (Silver Agent)",
    ...
    description: "Save 2% on every service & withdraw from ₦1,500.",
  },
  TIER_3: {
    level: "TIER_3",
    tierNumber: 3,
    name: "Gold",
    fullName: "Level 3 (Gold Pro)",
    badge: "🥇 Level 3 · Gold Pro",
    minSpend: 100000,
    maxSpend: 499999,
    discountPct: 4,
    ...
    description: "Save 4% on every service, faster job processing & withdraw from ₦1,000.",
  },
  TIER_4: {
    level: "TIER_4",
    tierNumber: 4,
    name: "Platinum",
    fullName: "Level 4 (Platinum VIP)",
    badge: "💎 Level 4 · Platinum VIP",
    minSpend: 500000,
    maxSpend: null,
    discountPct: 6,
    ...
    description: "Save 6% on every service, fastest VIP processing & withdraw from ₦500.",
  },
};
