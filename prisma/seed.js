...
async function runSeed() {
  ...
  const prices = [
    ...
    // Developer API Wholesale Slip Prices (150 NGN flat seed rate)
    { serviceKey: "API_NIN_BASIC", title: "API - Basic NIN Slip", price: 150.00 },
    { serviceKey: "API_NIN_VNIN", title: "API - VNIN Verification Slip", price: 150.00 },
    { serviceKey: "API_NIN_REGULAR", title: "API - Regular NIN Slip", price: 150.00 },
    { serviceKey: "API_NIN_STANDARD", title: "API - Standard Biometric Slip", price: 150.00 },
    { serviceKey: "API_NIN_PREMIUM", title: "API - Premium Card Slip", price: 150.00 },
